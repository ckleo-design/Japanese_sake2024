    ...
    const value = {
        sakeList: [
            ...
            },
            {
                ...
                name: 'Dassai 39',
                alink: 'Dassai-39',
                sake_detail: `This clear and refind sake exhibits a luscious and juicy character, introducing itself with a nectar-like sweetness that caresses the palate. As the flavours develop, they give way to a long, bright finale. The initial aroma profile shares similarities with Dassai Junmai Ginjou 45%, but upon tasting, layers of fragrances reveal themselves.\n\nSoft, sweet scents of cotton candy mingle with hints of banana and Japanese pears. The mid-palate experience shifts to a crisp, clean, and dry taste. Its smooth, clear, and refined nature is evident throughout, culminating in a long, bright finish.`,
            ...
            {
                image: 'Nito-Junmai-Daiginjo-Omachi-48',
                maker: 'MARUISHI SHUZO',
                name: 'Nito Junmai Daiginjo Omachi 48',
                alink: 'Nito-Junmai-Daiginjo-Omachi-48',
                sake_detail: `Nito Junmai Daiginjo is brewed using the renowned Omachi sake rice. This sake combines a full-bodied character with a refreshing taste profile. It has subtle notes of cherry blossoms on the nose.\n\nOn the palate, a well-balanced sweetness is complemented by a fruity viscosity that adds depth and complexity. A refined acidity provides structure and enhances the overall drinking experience. Despite its full-bodied nature, this sake maintains a surprising lightness from the first sip to the lingering clear aftertaste.\n\nThis versatile sake can be enjoyed at room temperature or chilled. It pairs exceptionally well with umami-rich game dishes.`,
                ...
                SMV: `+1`,
                area: `Aichi`,
                buy: `https://theartofsake.com/products/nito-junmai-daiginjo-omachi-48`
            },
            {
                image: 'Shinrai-Blue',
                maker: 'MIWA SHUZO',
                ...
                brewery_detail: `Founded in 1837, Miwa Shuzo is located in Ogaki City, known as the City of Water, in Gifu Prefecture. The brewery's most famous brand, Shirakawago, was created at the request of the Mayor of Shirakawa Village, a UNESCO Heritage site, to produce doburoku sake for the village's historic festival.\n\nUsing spring water from Mount Haku and high-quality rice from the Kaga plain, Miwa Shuzo employs innovative brewing techniques to balance hard and soft water, creating elegant and refined sake. Their Shinrai range is particularly suited for food pairings, offering a mix of styles with rich flavours and refined textures.`,
                sake_type: `Junmai`,
